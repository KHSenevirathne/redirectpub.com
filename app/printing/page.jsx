                ...
                <div className="row mb-70 mb-sm-50">
                  <div className="col-md-8 offset-md-2 text-center">
                    <p className="section-descr mb-0">
                      ...
                      digital printing, offset printing, large format, and
                      custom merchandise to help your brand stand out.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="container mt-60 mb-60">
                <div className="row justify-content-center">
                  <div className="col-md-4 mb-30">
                    <Image
                      src="https://images.unsplash.com/photo-1562564055-71e051d33c19?q=80&w=800&h=600&auto=format&fit=crop"
                      width={800}
                      height={600}
                      alt="Printing Service 1"
                  ...
                  <div className="col-md-4 mb-30">
                    <Image
                      src="https://images.unsplash.com/photo-1589829085413-56de8ae18c73?q=80&w=800&h=600&auto=format&fit=crop"
                      width={800}
                      height={600}
                      alt="Printing Service 2"
                      className="w-100 object-fit-cover rounded-4"
                      unoptimized
                    />
                  </div>
                  <div className="col-md-4 mb-30">
                    <Image
                      src="https://images.unsplash.com/photo-1562654501-a0ccc0fc3fb1?q=80&w=800&h=600&auto=format&fit=crop"
                      width={800}
                      height={600}
                      alt="Printing Service 3"
                      className="w-100 object-fit-cover rounded-4"
                      unoptimized
                    />
                  </div>
                ...
                <div className="row text-center">
                  <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                    ...
                    <p className="section-descr-medium mb-50 mb-sm-40">
                      Looking for reliable printing services? Contact us today
                      for a quote on your printing needs.
                    </p>
                ...
                <div className="row position-relative">
                  <div className="col-md-6 col-lg-5 mb-md-50 mb-sm-30">
                    ...
                    <p className="text-gray mb-0">
                      From business cards to banners, we handle all your
                      printing requirements with precision and speed. Our
                      advanced printing technology ensures vibrant colors and
                      sharp details.
                    </p>
                  </div>
