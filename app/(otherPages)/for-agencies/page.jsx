...
export const metadata = {
    title:
        "For Agencies || RedirectPub",
    description:
        "The Best Agency Service in UK",
};
export default function MainAgencyPage2() {
    return (
        <>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-8 offset-md-2">
                                                <h1 className="hs-title-1 mb-30">
                                                    ...
                                                    >
                                                        White-Label Services for Creative Agencies in Web Development
                                                    </span>
                                                </h1>
                                                <div className="row">
                                                    <div className="col-lg-10 offset-lg-1">
                                                        ...
                                                        >
                                                            a trustworthy code partner who will stick by you over time and provide answers to your business problems. With a wide range of web development experience, we can handle your projects and free up your time to concentrate on expanding your own company.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="page-section overflow-hidden pt-0 pb-0">
                                ...
                                <div className="marquee marquee-style-2 no-rotate">
                                    <div className="marquee-track marquee-animation-1">
                                        <div>We Partner with Leading Agencies</div>
                                        <div aria-hidden="true">We Partner with Leading Agencies</div>
                                        <div aria-hidden="true">We Partner with Leading Agencies</div>
                                        <div aria-hidden="true">We Partner with Leading Agencies</div>
                                        <div aria-hidden="true">We Partner with Leading Agencies</div>
                                        <div aria-hidden="true">We Partner with Leading Agencies</div>
                                    ...
                                    <div className="row mb-50 mb-sm-50">
                                        <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3 text-center">
                                            <h2 className="section-title-small mb-20">
                                                Why choose RedirectPub?
                                            </h2>
                                            <p className="text-gray mb-0">
                                                Thus you may grow your company offers to clients, access a wide range of skills and experience, optimise costs and effectiveness, and take on additional projects without worrying about capacity limitations. There's more, though.
                                            </p>
                                        </div>
                                    </div>
                                    {/* Features Grid */}
                                ...
                                <div className="container position-relative">
                                    <div className="row">
                                        <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
                                            <h2 className="section-title mb-xs-10">Our Clients</h2>
                                            <p className="mb-60 mb-sm-50">
                                                More than 1000 digital agencies from all over the world, including the US, Canada, Ireland, the UK, France, and Australia, use us as a white-label partner. We are here to help you expand your agency business since we understand the ins and outs.
                                            </p>
