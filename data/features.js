export const featureItems = [
  {
    ...
    description:
      "Top quality through clear communication, expert code, and best modern practices.",
  },
  {
    id: 2,
    className: "col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30",
    ...
    description:
      "We meet deadlines without sacrificing quality, thanks to our expert team.",
  },
  {
    id: 3,
    ...
    description:
      "We rely on expert teams, boosting creativity, efficiency, and top results.",
  },
];
...
export const featureItems2 = [
  {
    ...
    title: "Unique Design",
    description:
      "Custom projects from simple to complex, creating award-worthy results.",
  },
  {
    id: 2,
    className: "col-lg-6",
    ...
    title: "Quality Code",
    description:
      "Expertly crafted code for any scale, no project too simple or complex.",
  },
  {
    id: 3,
    className: "col-lg-6",
    ...
    description:
      "Elegant, uncluttered layouts that highlight your creativity and resources",
  },
  {
    id: 4,
    className: "col-lg-6",
    ...
    description:
      "Fully tailored to your needs, flexible growth for your award-quality site",
  },
];
